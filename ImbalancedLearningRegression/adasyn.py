...
def adasyn(
    ...
    beta = 1,  ## the ratio of minority:majority data desired after ADASYN, ß =1 means a perfectly balanced data set after ADASYN.
    ...
    'Adasyn' is selected when the distance between a given observation and a
    ...
    ## calculate the number of the minority observations and the majority observations
    ms = 0
    ml = 0
    for i in range(0, len(y_sort) - 1):
    ...
    ## ttl is the total number of minority data to generate.
    ttl = (ml-ms) * beta
